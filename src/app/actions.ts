...
import { evaluateTextResponse } from './algorithm';
import { generateCorrectAnswer, generateQuestionsFromText, generatePages } from './questions';
...
export const fetchApi = async () => {
    ...
    const thing = await evaluateTextResponse(exampleContent, exampleQuestion, exampleAnswer);
    console.log(thing);
}
